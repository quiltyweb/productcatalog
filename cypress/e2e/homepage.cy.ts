describe("HomePage", function () {
  describe("When page loads", () => {
    it("loads expected elements", () => {
      ...
      // TODO: loads a footer with correct headings
  ...
  describe.skip("When user types a search term in searchbox", () => {
  ...
  describe.skip("When user clicks on contact menu item", () => {
  ...
  describe.skip("When user clicks on Quote menu item", () => {
    it("loads Quote page", () => {
      cy.findByRole("navigation").within(() => {
  ...
  describe.skip("When user clicks on product menu item", () => {
