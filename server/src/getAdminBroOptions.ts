    ...
    locale: {
      ...
      translations: {
        ...
        messages: {
          ...
          successfullyBulkDeleted_plural: '{{count}} registros eliminados exitosamente',
          successfullyDeleted: 'Registro eliminado exitosamente',
          successfullyUpdated: 'Registro actualizado exitosamente',
          thereWereValidationErrors: 'Se encontraron errores de validacion - revise consola de errores.',
          successfullyCreated: 'Registro creado exitosamente',
          bulkDeleteError: 'Hubo un error al eliminar registros, revise consola de error para mas informacion',
          errorFetchingRecords: 'Hubo un error al obtener los registros, revise consola de error para mas informacion',
          errorFetchingRecord: 'Hubo un error al obtener el registro, revise consola de error para mas informacion',
          ...
          pickSomeFirstToRemove: 'Para eliminar registros, debe seleccionarlos primero',
          error404Resource: 'Recurso con ID: {{resourceId}} no se ha encontrado',
          error404Action: 'Recurso con ID: {{resourceId}} no tiene una accion con nombre: {{actionName}}',
          error404Record: 'Recurso con ID: {{resourceId}} no tiene registro con id: {{recordId}}',
          seeConsoleForMore: 'Revise consola de desarrollo para mas detalles...',
          noActionComponent: 'Tiene que implementar un componente de accion para su Accion',
