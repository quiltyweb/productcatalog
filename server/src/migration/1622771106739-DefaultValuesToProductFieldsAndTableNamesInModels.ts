...
export class DefaultValuesToProductFieldsAndTableNamesInModels1622771106739 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "attachment_path"`);
        await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "supplier_name"`);
        ...
        await queryRunner.query(`ALTER TABLE "products" ADD "imagePath" character varying NOT NULL DEFAULT ''`);
        await queryRunner.query(`ALTER TABLE "products" ADD "attachmentPath" character varying NOT NULL DEFAULT ''`);
        await queryRunner.query(`ALTER TABLE "products" ADD "purchasePrice" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "products" ADD "salePrice" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "products" ADD "supplierName" character varying NOT NULL DEFAULT ''`);
        ...
        await queryRunner.query(`CREATE SEQUENCE "products_id_seq" OWNED BY "products"."id"`);
        ...
        await queryRunner.query(`CREATE SEQUENCE "categories_id_seq" OWNED BY "categories"."id"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "categories" DROP COLUMN "name"`);
        await queryRunner.query(`ALTER TABLE "categories" ADD "name" character varying(80) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "description"`);
        await queryRunner.query(`ALTER TABLE "products" ADD "description" text NOT NULL DEFAULT ''`);
        await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "name"`);
        await queryRunner.query(`ALTER TABLE "products" ADD "name" character varying(80) NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "supplierName"`);
        ...
        await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "attachmentPath"`);
        ...
        await queryRunner.query(`ALTER TABLE "products" ADD "sale_price" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "products" ADD "purchase_price" integer NOT NULL`);
        await queryRunner.query(`ALTER TABLE "products" ADD "supplier_name" character varying NOT NULL DEFAULT ''`);
        await queryRunner.query(`ALTER TABLE "products" ADD "attachment_path" character varying NOT NULL DEFAULT ''`);
        await queryRunner.query(`ALTER TABLE "products" ADD "image_path" character varying NOT NULL DEFAULT ''`);
